...
params = {
    "dataset_params": {
        ...
        "config": {
            "save_image": None, #"debug_images_dan_READ_page_real", # "debug_images_dan_READ_page_real",  # set to None to disable image saving
            ...
            "raw_resize": (64, 1232),  # Resize images to this size before to apply any other transformation (None to disable)
    ...
    "training_params": {
        "output_folder": "DAN_READ_page_pretrainedonlyMIM_READBAUTZEN",  # folder name for checkpoint and results dan_IAM_page, dan_read_page, dan_rimes_page
        "max_nb_epochs": 900,  # maximum number of epochs before to stop
        ...
        "batch_size": 6,  # mini-batch size for training
