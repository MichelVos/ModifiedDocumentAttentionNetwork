...
dataset_name = "IAM"  # ["IAM", "READ_2016", "IAM"]
...
params = {
    "dataset_params": {
        ...
        "config": {
            "save_image": "debug_images_dan_IAM_page_synthetic",  # set to None to disable image saving
            "load_in_memory": True,  # Load all images in CPU memory
            "worker_per_gpu": 6,  # Num of parallel processes per gpu for data loading
            ...
            # "synthetic_data": None,
            "non_synthetic_data": {
                "init_proba": 0.98,  # begin proba to generate synthetic document
    ...
    "model_params": {
        ...
        "transfer_learning": {
            ...
            #"encoder": ["encoder", "outputs/FCN_IAM_line_non_syn/checkpoints/best.pt", True, True],
            #"decoder": ["decoder", "outputs/FCN_IAM_line_non_syn/checkpoints/best.pt", True, False],
    ...
    "training_params": {
        "output_folder": "dan_IAM_page_20251129",  # folder name for checkpoint and results dan_IAM_page, dan_read_page, dan_rimes_page
        ...
        "eval_metrics": ["cer", "wer", "time", "map_cer", "loer"],  # Metrics name for evaluation on validation set during training
